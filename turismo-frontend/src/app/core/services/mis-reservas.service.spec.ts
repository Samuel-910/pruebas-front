// src/app/core/services/mis-reservas.service.ts
...
export class MisReservasService {
  ...
  cambiarEstadoReserva(id: number, estado: 'pendiente' | 'confirmada' | 'cancelada' | 'completada'): Observable<Reserva> {
  ...
  cambiarEstadoServicioReserva(servicioReservaId: number, estado: 'pendiente' | 'confirmado' | 'cancelado' | 'completado'): Observable<ReservaServicio> {
